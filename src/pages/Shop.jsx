        ...
        <>
            ...
            <div>
                <Container className="section_spacing">
                    <h2 className="section-title mb-5 text-center">Our Top Picks</h2>
                    <Row>
                        {products.map((product) => (
                            <Col key={product.id} xs={12} sm={6} md={3} className="mb-4">
                                <Card className="product_data">
                                    <div className="product_image">
                                        <Card.Img variant="top" src={product.image} />
                                    </div>
                                    <Card.Body>
                                        <h5 className="text-dark mb-2 product_name">
                                            {product.name}
                                        </h5>
                        ...
                        <div>
                            <Container>
                                <div className="text-center mb-5 shop_wrp">
                                    <h6 className="shop-text">SHOP</h6>
